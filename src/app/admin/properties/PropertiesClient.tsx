  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="bg-luxury-800 border border-luxury-700 rounded-2xl px-5 py-4 flex flex-col sm:flex-row items-start sm:items-center gap-4 flex-wrap">
              ...
              <button
                ...
                <span
                  className={`text-[10px] font-bold tabular-nums ${
                    status === s.value ? "text-luxury-900/70" : "text-luxury-600"
                  }`}>
                  {count}
                </span>
              </button>
        ...
        {/* Divider */}
        <div className="hidden sm:block w-px h-5 bg-luxury-700" />
        ...
        <div className="relative sm:ml-auto">
          ...
          <input
            ...
            className="bg-luxury-900 border border-luxury-700 hover:border-gold-500/50 focus:border-gold-500 rounded-lg pl-9 pr-9 py-2 text-luxury-50 placeholder-luxury-500 text-sm outline-none transition-colors w-56"
          />
          {search && (
            <button
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-luxury-700 bg-luxury-900/40">
                  {["Property", "Price", "Type", "Status", "Featured", "Date", ""].map(
                    (h) => (
                      <th
                        key={h}
